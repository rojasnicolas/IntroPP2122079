Inside this folder you can find 4 files, omp_deficient_numbers.c (code), omp_deficient_numbers (compile file), deficient_numbers.sbatch (configure file slurm) and output_deficient_numbers_omp.txt (results).
